---
name: create-plan
description: Create detailed implementation plans through interactive, iterative process. Use when users ask for implementation planning, phased execution plans, or technical specifications before coding.
version: '1.0.0'
...
- `find_files`: `./subrecipes/rpi-codebase-locator.yaml`
- `analyze_code`: `./subrecipes/rpi-codebase-analyzer.yaml`
- `find_patterns`: `./subrecipes/rpi-pattern-finder.yaml`
