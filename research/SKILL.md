---
name: research
description: Research and document codebase for a specific topic using parallel sub-agents. Use when users ask to investigate how code currently works and produce a structured technical map.
version: '1.0.0'
